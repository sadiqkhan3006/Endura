...
function Services() {
  const services = [
    ...
    {
      id: 3,
      desc: "We offer high-quality product photoshoots at the best rates, whether you needclean, simple background shots or creative setups with props to make your products stand out.",
  ...
  return (
    <div className="mt-[32px] md:mt-[60px] lg:mt-[80px] mb-[32px] md:mb-[60px] lg:mb-[160px]  overflow-x-hidden px-[6%]">
      ...
      <div className="flex flex-row gap-x-6  justify-center  flex-wrap gap-y-6 mt-[35px] ">
        {services.map((data) => (
          <div
            key={data.id}
            className="flex flex-col w-auto md:w-[320px]  lg:w-[325px]  "
          >
